      ...
      <Element name="#About" className="h-screen sm:my-0 mb-20 sm:mb-0 pt-20 sm:pt-0">
        ...
        <div className=" sm:grid sm:grid-cols-2">
          ...
          <div className="my-auto text-center sm:text-left">
            ...
            <p className="py-5">
              Holla.. My name is Hadi Rachmat Supindar, I was Born on july, 8, 2001 at sukabumi city
              Now i live on Sukabumi city, West java Of Indonesia. My Current activities are as Student 
              At Sukabumi Muhammadiyah University, My other job is as a freelance worker in the field of informatics
              and then i as an active student majoring in informatics engineering
            </p>
